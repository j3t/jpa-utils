 ...
 * @author j3t
 */
@ContextConfiguration(classes = { DerbyConfig.class, JpaConfig.class, OpenJPAConfig.class })
public class OpenJPAEntityManagerHelperDerbyTest extends EntityManagerHelperImplTest
{
}
